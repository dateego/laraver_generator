...
use Dateego\Generators\Generators\SchemaGenerator;
use Dateego\Generators\Syntax\AddForeignKeysToTable;
use Dateego\Generators\Syntax\AddToTable;
use Dateego\Generators\Syntax\DroppedTable;
use Dateego\Generators\Syntax\RemoveForeignKeysFromTable;
...
class MigrationGeneratorCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'dateego:generate.migration {tables? : A list of Tables you wish to Generate Migrations for separated by a comma: users,posts,comments}
                                                {--connection= : The database connection to use.}
                                                {--ignore= : A list of Tables you wish to ignore, separated by a comma: users,posts,comments}
                                                {--path= :  Where should the file be created?}
                                                {--templatePath= : The location of the template for this generator}
    ...
    /**
     * @var \Dateego\Generators\Generators\SchemaGenerator
     */
    ...
    /**
     * @param \Dateego\Generators\Generators\Generator  $generator
     * @param \Dateego\Generators\Filesystem\Filesystem  $file
     * @param \Dateego\Generators\Compilers\TemplateCompiler  $compiler
