<?php
namespace Dateego\Generators\Templates\Data;

use App;
use Dateego\Generators\Parsers\MigrationFieldsParser;
use Dateego\Generators\Parsers\MigrationNameParser;
...
class Migration {
    ...
    {
        return App::make('Dateego\Generators\SchemaCreator');
    }
